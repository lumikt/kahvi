...
class StringTest(unittest.TestCase):
    ...
    def test_article_text_string_conversion(self):
        ...
        correct_format += '   journal = "Journal",\n   year = "2024"\n}\n'
    ...
    def test_inproceedings_text_string_conversion(self):
        ...
        correct_format += '   booktitle = "Testing",\n   year = "2024",\n   volume = "2"\n}\n'
    ...
    def test_book_text_string_conversion(self):
        ...
        correct_format +='   publisher = "Testing Publisher",\n   year = "2024"\n}\n'
        formatted_string =reference_to_string(self.book_dict, False)
        self.assertEqual(formatted_string, correct_format)

    def test_article_html_string_conversion(self):
        correct_format = '@ARTICLE{article_test_case,<br>&nbsp;&nbsp;&nbsp;author = "Jane Doe",<br>&nbsp;&nbsp;&nbsp;'
        correct_format += 'title = "Testing",<br>&nbsp;&nbsp;&nbsp;journal = "Journal",<br>&nbsp;&nbsp;&nbsp;year = "2024"<br>}<br>'
        formatted_string =reference_to_string(self.article_dict, True)
        self.assertEqual(formatted_string, correct_format)

    def test_inproceedings_html_string_conversion(self):
        correct_format = '@INPROCEEDINGS{inproceedings_test_case,<br>&nbsp;&nbsp;&nbsp;author = "Jane Doe",<br>&nbsp;&nbsp;&nbsp;'
        correct_format += 'booktitle = "Testing",<br>&nbsp;&nbsp;&nbsp;year = "2024",<br>&nbsp;&nbsp;&nbsp;volume = "2"<br>}<br>'
        formatted_string =reference_to_string(self.in_proceedings_dict, True)
        self.assertEqual(formatted_string, correct_format)

    def test_book_html_string_conversion(self):
        correct_format = '@BOOK{book_test_case,<br>&nbsp;&nbsp;&nbsp;author = "Jane Doe",<br>&nbsp;&nbsp;&nbsp;'
        correct_format += 'title = "Testing",<br>&nbsp;&nbsp;&nbsp;publisher = "Testing Publisher",<br>&nbsp;&nbsp;&nbsp;year = "2024"<br>}<br>'
